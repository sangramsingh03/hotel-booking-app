...
```bash
git clone https://github.com/sangramsingh03/hotel-booking-app
cd hotel-booking-app
```

## Backend Configuration

1. **Environment Files**: Navigate to the `backend` folder and create file: `.env`. Add the following contents to file:
